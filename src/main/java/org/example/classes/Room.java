...
public abstract class Room {
    ...
    protected void handleInput(char move) {
        switch (move) {
            case 'w':
                if (playerY > 0 || (playerY == 0 && doorWall == 0 && playerX == doorX)) playerY--;
                break;
            case 's':
                if (playerY < height - 1 || (playerY == height - 1 && doorWall == 1 && playerX == doorX)) playerY++;
                break;
            case 'a':
                if (playerX > 0 || (playerX == 0 && doorWall == 2 && playerY == doorY)) playerX--;
                break;
            case 'd':
                if (playerX < width - 1 || (playerX == width - 1 && doorWall == 3 && playerY == doorY)) playerX++;
                break;
            case 'q':
                clearScreen();
                System.exit(0);
    ...
    protected void clearScreen() {
        // \33[2J clears the terminal screen and \33[H resets the cursor
